...
const eurekaUtils = require('./eureka-util');
...
app.get('/node/testbookservice', function(req, res){
    var msg = 'follow is bookservice message';
    //需要大写
    //console.log(client.getInstancesByVipAddress('BOOK-SERVICE'));
    //console.log(client);
    msg = msg + eurekaUtils.getBookRootUrl(client);
    res.status(200);
    res.end(msg);
})